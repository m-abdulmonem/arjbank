...
namespace Mabdulmonem\ArjBank;

use Illuminate\Support\Facades\Http;

class BaseClass
{
    public function merchantPayment(array $paymentData, int|float|string $amount, string $response_url, string $error_url, array $optionalData = [])
    {
    ...
    public function bankHostedPayment(int|float|string $amount, string $response_url, string $error_url, array $optionalData = [])
    {
        $trackId = rand(111111111, 999999999);
